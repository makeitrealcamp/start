  ...
  describe "POST #create_proinnovate_2024_applicant" do
    it "responds with status 200" do
      ...
      post :create_proinnovate_2024_applicant, 
          params: { applicant:{ program_name: "", convertloop_event: "qa-tester", first_name: "Pedro", last_name: "Perez", email: "pedro@example.com" }}  
      expect(response).to have_http_status(:ok)
    end
  end
  ...
  describe "POST #create_mitic_applicant" do
    it "responds with status 200" do
      ...
      post :create_mitic_applicant, 
          params: { applicant: {program_name: "AI", first_name: "Pedro", last_name: "Perez", email: "pedro@example.com" }}
      expect(response).to have_http_status(:ok)
    end
  end
end
