class TopProgramTestView extends Backbone.View
  el: '.top-test-page'
  ...
  initialize: (@questions, version) ->
    ...
    if version == 1
      @a4 = CodeMirror.fromTextArea(document.getElementById("a4"), @options)
      @a4.setSize(null, 200)
    else
...
window.TopProgramTestView = TopProgramTestView
