...
ready_pricing = function() {
  ...
  $.get("http://ipinfo.io", function(response) {
    if(response.country == "CO") {
      $("#financing").html("<div class='primera-cuota'><span class='price-one'>$800,000</span></br>Primera cuota</div>" + "<div class='plus'>+</div>" + "<div class='otras-cuotas'><span class='price-one'>$320,000</br></span>5 cuotas mensuales</div>" + "<p class='valor-total'>O paga <span class='directo'>$2,060,000</span> de entrada y ahorra <span class='valor-ahorro'>$340,000</span></p>" + "<div class='caption'><p>Recibimos todos los medios de pago. Precios en pesos colombianos.</p></div>");
    }
    else {
      $("#financing").html("<div class='primera-cuota'><span class='price-one'>$299</span></br>Primera cuota</div>" + "<div class='plus'>+</div>" + "<div class='otras-cuotas'><span class='price-one'>$150</br></span>6 cuotas mensuales</div>" + "<p class='valor-total'>O paga <span class='directo'>$900</span> de entrada y ahorra <span class='valor-ahorro'>$299</span></p>" + "<div class='caption'><p>Recibimos todos los medios de pago. Precios en dólares americanos.</p></div>");
    }
  }, "jsonp"); 
