class CreateLeadJob < ActiveJob::Base
  ...
  def perform(data)
    ...
    person = { pid: pid, email: email, first_name: first_name, last_name: last_name,
        ...
        linkedin: linkedin, goal: goal, experience: experience, additional: additional, format: format,
        payment_method: payment_method, stipend: stipend, user_id_type: user_id_type, user_id_number: user_id_number }
    begin
