class Quizer::MultiAnswerQuestionForm < BaseForm
  attribute :question, Quizer::MultiAnswerQuestion
  ...
  def self.sanitize_params(params)
    params
      .require(:question)
      .permit(:text, :published, :explanation, correct_answers:[], wrong_answers:[])
  end
