...
User.create(email: "admin@makeitreal.camp", account_type: User.account_types[:admin_account], password: "mir1234")

User.create(email: "user_free@makeitreal.camp",account_type: User.account_types[:free_account], password: "mir1234")

User.create(email: "user_paid@makeitreal.camp",account_type: User.account_types[:paid_account], password: "mir1234")